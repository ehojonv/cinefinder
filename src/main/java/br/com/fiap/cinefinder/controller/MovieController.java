...
public class MovieController {
    ...
    public EntityModel<GetMovieDto> createMovie(@RequestBody Movie movie) {
        log.info("criando novo movie: {}", movie);
        return service.save(movie);
    }

    @PutMapping("{id}")
    public EntityModel<GetMovieDto> updateMovie(@PathVariable Long id, @RequestBody Movie upd) {
